  ...
  return (
    <div className="pointer-events-none absolute inset-0 overflow-hidden">
      <motion.div
        ...
        style={{
          background:
            "radial-gradient(circle, oklch(0.5 0.3 300 / 70%), transparent 70%)",
        }}
      ...
      <motion.div
        ...
        style={{
          background:
            "radial-gradient(circle, oklch(0.55 0.25 285 / 60%), transparent 70%)",
        }}
      ...
      <motion.div
        ...
        style={{
          background:
            "radial-gradient(circle, oklch(0.6 0.25 288 / 50%), transparent 70%)",
        }}
