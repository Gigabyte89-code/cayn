  ...
  return (
    <div className="pointer-events-none absolute inset-0 overflow-hidden">
      <motion.div
        ...
        style={{
          background:
            "radial-gradient(circle, oklch(0.5 0.3 280 / 70%), transparent 70%)",
        }}
      ...
      <motion.div
        ...
        style={{
          background:
            "radial-gradient(circle, oklch(0.55 0.25 220 / 60%), transparent 70%)",
        }}
      ...
      <motion.div
        ...
        style={{
          background:
            "radial-gradient(circle, oklch(0.6 0.25 320 / 50%), transparent 70%)",
        }}
