  ...
  return (
    <section id="services" className="relative px-6 py-32">
      <div
        ...
        style={{ background: "radial-gradient(circle, oklch(0.55 0.25 300 / 50%), transparent 70%)" }}
      />
              ...
              <TiltCard className="group relative h-full">
                <div className="glass-liquid relative h-full overflow-hidden rounded-3xl p-7 transition-all duration-500 hover:bg-white/[0.08]">
                  <div
                    ...
                    style={{ background: "radial-gradient(circle, oklch(0.65 0.25 300 / 60%), transparent 70%)" }}
                  />
